...
public class UnsubscribeRequest extends AbstractEvent<UnsubscribeRequest> {
  ...
  public UnsubscribeRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public UnsubscribeRequest exchange(ExchangeEnum exchange) {
