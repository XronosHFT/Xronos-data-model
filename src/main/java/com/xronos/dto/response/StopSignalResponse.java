...
public class StopSignalResponse extends AbstractEvent<StopSignalResponse> {
  ...
  public StopSignalResponse stopStatus(boolean stopStatus) {
  ...
  public void writeMarshallable(WireOut out) {
    ...
    if (PREGENERATED_MARSHALLABLE) {
      ...
      out.write("stopStatus").writeBoolean(stopStatus);
    }
  }
  ...
  public void readMarshallable(WireIn in) {
    ...
    if (PREGENERATED_MARSHALLABLE) {
      ...
      stopStatus = in.read("stopStatus").readBoolean();
    }
  }
}
