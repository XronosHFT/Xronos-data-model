...
public class SubscribeAccountRequest extends AbstractEvent<SubscribeAccountRequest> {
  ...
  public SubscribeAccountRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribeAccountRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribeAccountRequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribeAccountRequest accountId(String accountId) {
  ...
  public SubscribeAccountRequest apiName(String apiName) {
