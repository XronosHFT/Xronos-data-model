...
public class SubscribePositionRequest extends AbstractEvent<SubscribePositionRequest> {
  ...
  public SubscribePositionRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribePositionRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribePositionRequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribePositionRequest accountId(String accountId) {
  ...
  public SubscribePositionRequest apiName(String apiName) {
