...
public class SubscribeMarketBBORequest extends AbstractEvent<SubscribeMarketBBORequest> {
  ...
  public SubscribeMarketBBORequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribeMarketBBORequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribeMarketBBORequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribeMarketBBORequest accountId(String accountId) {
  ...
  public SubscribeMarketBBORequest apiName(String apiName) {
