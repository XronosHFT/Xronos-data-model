...
public class SubscribeBalanceRequest extends AbstractEvent<SubscribeBalanceRequest> {
  ...
  public SubscribeBalanceRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribeBalanceRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribeBalanceRequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribeBalanceRequest accountId(String accountId) {
  ...
  public SubscribeBalanceRequest apiName(String apiName) {
