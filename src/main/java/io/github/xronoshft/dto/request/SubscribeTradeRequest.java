...
public class SubscribeTradeRequest extends AbstractEvent<SubscribeTradeRequest> {
  ...
  public SubscribeTradeRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribeTradeRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribeTradeRequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribeTradeRequest accountId(String accountId) {
  ...
  public SubscribeTradeRequest apiName(String apiName) {
