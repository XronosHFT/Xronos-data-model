...
public class QueryContractRequest extends AbstractEvent<QueryContractRequest> {
  ...
  public QueryContractRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public QueryContractRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public QueryContractRequest exchange(ExchangeEnum exchange) {
  ...
  public QueryContractRequest accountId(String accountId) {
  ...
  public QueryContractRequest apiName(String apiName) {
