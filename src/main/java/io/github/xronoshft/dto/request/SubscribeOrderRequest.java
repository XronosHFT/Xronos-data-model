...
public class SubscribeOrderRequest extends AbstractEvent<SubscribeOrderRequest> {
  ...
  public SubscribeOrderRequest period(IntervalEnum period) {
    this.period = period;
    return this;
  }
  ...
  public SubscribeOrderRequest symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public SubscribeOrderRequest exchange(ExchangeEnum exchange) {
  ...
  public SubscribeOrderRequest accountId(String accountId) {
  ...
  public SubscribeOrderRequest apiName(String apiName) {
